...
const RecentVideos: React.FC = () => {
  ...
  // Find recent videos based on last watched time
  const recentVideos = useMemo(() => {
    // Create array from video progress records
    ...
    // Find video details from playlists
    const videos: Video[] = [];
  ...
  // Map progress to video IDs for easy lookup
